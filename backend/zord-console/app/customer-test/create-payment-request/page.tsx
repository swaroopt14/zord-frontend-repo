...
export default function CustomerTestCreatePaymentRequestPage() {
            ...
            {resp?.EnvelopeID ? (
              <div className="rounded-xl border border-emerald-200 bg-emerald-50 px-4 py-3">
                <div className="flex items-start justify-between gap-3">
                  ...
                  <Link
                    href="/customer-test/intent-journal"
            ...
            <div className="pt-2 flex items-center justify-between gap-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  onClick={onSubmit}
                  disabled={submitting}
                  className="px-4 py-2 text-sm font-semibold bg-slate-700 text-white rounded-lg hover:bg-slate-800 transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
                >
